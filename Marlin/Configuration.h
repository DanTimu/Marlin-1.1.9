...
#define STRING_CONFIG_H_AUTHOR "(DT, Anet config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // #define DEFAULT_Kd 97.25

  // PID tuning with fan 100%:
  #define DEFAULT_Kp 26.60
  #define DEFAULT_Ki 1.97
  #define DEFAULT_Kd 89.89
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 95.2 } // modificat la extruderul curent 100 -> 95.2
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 10, 50 } //modificat Z (default: 8)
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.43 // Z offset: -below +above  [the nozzle] // masurat la cald pe sticla
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3 // number of grid points ( 3 x 3 )
...
// X_PROBE_OFFSET_FROM_EXTRUDER -24 
// Y_PROBE_OFFSET_FROM_EXTRUDER -38

  #define LEFT_PROBE_BED_POSITION (X_BED_SIZE - (X_BED_SIZE  + X_PROBE_OFFSET_FROM_EXTRUDER))
  #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE + X_PROBE_OFFSET_FROM_EXTRUDER)
  #define FRONT_PROBE_BED_POSITION (Y_BED_SIZE - (Y_BED_SIZE + Y_PROBE_OFFSET_FROM_EXTRUDER))
  #define BACK_PROBE_BED_POSITION (Y_BED_SIZE + Y_PROBE_OFFSET_FROM_EXTRUDER)

  // #define LEFT_PROBE_BED_POSITION (X_BED_SIZE - (X_BED_SIZE  + X_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE))
  // #define RIGHT_PROBE_BED_POSITION (X_BED_SIZE  + X_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE)
  // #define FRONT_PROBE_BED_POSITION (Y_BED_SIZE - (Y_BED_SIZE + Y_PROBE_OFFSET_FROM_EXTRUDER - MIN_PROBE_EDGE))
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (150*60) // default(6000mm/m = 100mm/s)
#define HOMING_FEEDRATE_Z  (20*60) // default(240mm/m = 4mm/s)
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { -10, 135, (Z_MIN_POS + 5.5)}
  #define NOZZLE_CLEAN_END_POINT   {-15, 170, (Z_MIN_POS + 5.5)}
